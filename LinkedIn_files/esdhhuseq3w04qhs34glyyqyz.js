...
return}const s={id:a}
i.resolve({data:s})}))
return(0,s.all)(c)})).catch((e=>E(d,c,e))).then((()=>{}))}batchDelete(e,t,r){let i=r.url||this.buildURL(e,null,null,"deleteRecord")
...
return(0,s.allSettled)(o)})).catch((e=>E(n,o,e))).then((()=>{}))}createRecord(e,t,r){const i=e.serializerFor(r.modelName),a=r.adapterOptions||{}
...
s.resolve({data:l})}))
return(0,s.all)(n).then((()=>e))})).catch((e=>E(o,n,e))).then((e=>e))}deleteRecord(e,t,r){const i=r.adapterOptions||{}
...
return this._sendAjaxRequest(e,t,i)}_sendAjaxRequest(e,t,r){if(!(r&&r.data&&(null!=r.data.decorationId||null!=r.data.recipe||r.recipe))){let i=this._pemberlyAjax(e,t,r)
0
...
i=o[3]||o[6]
a=e+t}else(function(e){return"object"==typeof e&&null!==e&&"object"==typeof e.data&&null!==e.data&&"string"==typeof e.data.queryId})(r)&&(i=r.data.queryId)
...
const e=(0,b.default)()
null==e||e.reload()}}throw e}isLogout(e){return"logout"===e}},k=(0,i.default)(O.prototype,"globalHttpHeaders",[v],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),x=(0,i.default)(O.prototype,"cachePrefetch",[_],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),M=(0,i.default)(O.prototype,"router",[w],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),E=(0,i.default)(O.prototype,"fastboot",[j],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),O))||P)
e.default=N}))
define("voyager-web/app",["exports","@babel/runtime/helpers/esm/defineProperty","ember-cli-pemberly-tracking/track-popstate-reopen","@ember/runloop","@ember/application","ember-load-initializers","strict-resolver","voyager-web/config/environment","voyager-web/hacks/boot-time"],(function(e,t,r,i,a,o,n,s,l){Object.defineProperty(e,"__esModule",{value:!0})
e.default=void 0
var u
0
...
e.default=m}))
define("voyager-web/controllers/authentication",["exports","@babel/runtime/helpers/esm/initializerDefineProperty","@babel/runtime/helpers/esm/defineProperty","@babel/runtime/helpers/esm/applyDecoratedDescriptor","@babel/runtime/helpers/esm/initializerWarningHelper","@ember/destroyable","@ember/controller","@glimmer/tracking","@ember/service","@ember/application","@ember/object","cache-prefetch/utils/cache-prefetch-config","ember-app-scheduler","ember-cli-pemberly-tracking/utils/user-timing","global-utils/utils/is-browser","global-utils/utils/transition","voyager-web/utils/new-tab-tracker","module-boundary-utils","module-boundary-utils/-private/is-isolated-build","voyager-web/config/environment"],(function(e,t,r,i,a,o,n,s,l,u,d,c,p,f,m,h,b,g,y,v){Object.defineProperty(e,"__esModule",{value:!0})
e._shouldEnableCoachOverlay=Y
e._shouldEnableMessagingOverlay=Z
e.default=void 0
var _,w,j,P,O,k,x,M,E,N,T,A,z,R,U,S,I,C,D,L,q,K,F,H,B,$
const G={feed:["notifications","mynetwork","jobs"],jobs:["notifications","feed","messaging","mynetwork"],me:["notifications","feed","profile"],mynetwork:["notifications","feed","messaging","jobs"],notifications:["feed","messaging","mynetwork","jobs"],profile:["notifications","feed","messaging","mynetwork","jobs"],"member-analytics":["notifications","feed","profile"]},V=["jobs-search","jobs-collections","jobs.index","jobs.index.index","jobs-search_loading","jobs-search.index","jobs.saved","jobs.applied","search.jobs"],W=["ad-preview.preview",/^article-editor\./,"feed.hashtag-feed.present","feed.live-preview","feed.sponsored-update","feed.sales-navigator","news.feed-update-preview",/^onboarding\./,/^inshare\./,"premium.welcome-flow","premium.products","premium.survey",/^premium\.cancellation/,/^premium\.switcher/,/^premium\.redeem-v3/,/^profile-skill-assessments\./,"video-engine.embed","video-engine.live",/^video-engine.go-live\./,"msg-video-call.index",/^job-posting\./,/^trust-verifications\./],Q=["ad-preview.preview","events.theater","feed.live-preview","feed.sponsored-update",/^inshare\./,"video-engine.embed","video-engine.live",/^video-engine.go-live\./]
function Z(e){if(!(0,g.hasBundle)("msg-overlay"))return!1
const t=e.to?e.to.name:null
for(let e=0;e<W.length;e+=1){const r=W[e],i=r instanceof RegExp&&r.test(t)
if(t===r||i)return!1}return!0}function Y(e){const t=e.to?e.to.name:null
for(let e=0;e<Q.length;e+=1){const r=Q[e],i=r instanceof RegExp&&r.test(t)
if(t===r||i)return!1}return!0}const J="authentication-outlet",X=`${J} nav-hidden`
let ee=(_=(0,l.inject)("router"),w=(0,l.inject)("cache-prefetch@cache-prefetch"),j=(0,l.inject)("client-sensor-web@client-sensor"),P=(0,l.inject)("tracking"),O=(0,l.inject)("lix"),k=(0,l.inject)("prefetch"),x=(0,l.inject)("authentication@authenticated-user"),M=(0,l.inject)("global-nav-shared@nav-interaction"),E=(0,l.inject)("s-upsell@detached-upsell-modal"),N=(0,l.inject)("coach-shared@onboarding"),T=class extends n.default{get isUpsellTemplateComponentV2Enabled(){return this.lix.getTreatmentIsEnabled("voyager.web.premium-upsell-template-components-v2")}get isCoachEnabled(){return!(0,y.isIsolatedBuild)()&&!this.coachIsDisabledForRoute}get showNav(){return this.navInteraction.globalNavIsVisible}get isGuest(){return this.authenticatedUser.isGuestUser}get guestUserHasMID(){return!!this.authenticatedUser.midToken}get outletClass(){return this.showNav?J:X}get isGlobalSearchBarHidden(){const e=this.router.currentRouteName,t=this._previousRoute
return!("authentication.loading"!==e||!V.some((e=>null==t?void 0:t.includes(e))))||V.some((t=>e.includes(t)))}get withAIInsightsModal(){return"feed.index.index"===this.router.currentRouteName&&this.lix.getTreatmentIsEnabled("voyager.web.coach-mvp")&&this.lix.getTreatmentIsEnabled("voyager.web.coach-feed-splash-screen")}constructor(){super(...arguments);(0,r.default)(this,"queryParams",["chatId","msgOverlay","msgCompose","msgConversationId","msgConferenceId","msgRecipientId","msgControlName"]);(0,t.default)(this,"router",A,this);(0,t.default)(this,"cachePrefetch",z,this);(0,t.default)(this,"clientSensor",R,this);(0,t.default)(this,"tracking",U,this);(0,t.default)(this,"lix",S,this);(0,t.default)(this,"prefetch",I,this);(0,t.default)(this,"authenticatedUser",C,this);(0,t.default)(this,"navInteraction",D,this);(0,t.default)(this,"detachedUpsellModal",L,this);(0,t.default)(this,"coachOnboardingService",q,this);(0,t.default)(this,"searchKeywords",K,this);(0,t.default)(this,"isMessagingOverlayEnabled",F,this);(0,t.default)(this,"coachIsDisabledForRoute",H,this);(0,t.default)(this,"targetName",B,this);(0,t.default)(this,"_previousRoute",$,this);(0,r.default)(this,"canCachePrefetch",!0);(0,r.default)(this,"isBrowser",m.default);(0,r.default)(this,"isDevelopmentEnvironment","development"===v.default.environment);(0,r.default)(this,"newTabTracker",void 0)
...
const e=t.split(".")[0],r=G[e]
return this.cachePrefetch.fetch(e,c.default,r)}))}}_toggleMessagingOverlay(e){if(!(0,h.isQueryParamsOnly)(e))if(m.default&&Z(e)&&!this.isGuest){f.default.addMarker("mark_msg-overlay_overall_start")
...
throw e}))}else this.isMessagingOverlayEnabled=!1}_toggleCoachOverlay(e){this.coachIsDisabledForRoute=!Y(e)
...
this.newTabTracker&&this.newTabTracker.destroy()}setSearchKeywords(e){this.searchKeywords=e}handleTransitionToRoute(){this.transitionToRoute.apply(this,[...arguments])}},A=(0,i.default)(T.prototype,"router",[_],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),z=(0,i.default)(T.prototype,"cachePrefetch",[w],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),R=(0,i.default)(T.prototype,"clientSensor",[j],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),U=(0,i.default)(T.prototype,"tracking",[P],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),S=(0,i.default)(T.prototype,"lix",[O],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),I=(0,i.default)(T.prototype,"prefetch",[k],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),C=(0,i.default)(T.prototype,"authenticatedUser",[x],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),D=(0,i.default)(T.prototype,"navInteraction",[M],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),L=(0,i.default)(T.prototype,"detachedUpsellModal",[E],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),q=(0,i.default)(T.prototype,"coachOnboardingService",[N],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),K=(0,i.default)(T.prototype,"searchKeywords",[s.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return""}}),F=(0,i.default)(T.prototype,"isMessagingOverlayEnabled",[s.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return!1}}),H=(0,i.default)(T.prototype,"coachIsDisabledForRoute",[s.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return!1}}),B=(0,i.default)(T.prototype,"targetName",[s.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),$=(0,i.default)(T.prototype,"_previousRoute",[s.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return""}}),(0,i.default)(T.prototype,"setSearchKeywords",[d.action],Object.getOwnPropertyDescriptor(T.prototype,"setSearchKeywords"),T.prototype),(0,i.default)(T.prototype,"handleTransitionToRoute",[d.action],Object.getOwnPropertyDescriptor(T.prototype,"handleTransitionToRoute"),T.prototype),T)
e.default=ee}))
...
i.default.sharedServices.forEach((e=>{const t=`service:${e}`
...
var o={name:"auto-engine-dependencies",needs:["service:lix"],initialize:function(){}}
e.default=o}))
...
e.default=void 0
var r=(0,t.modifier)((function(e,t){let[r]=t
r(e)
return()=>{}}))
e.default=r}))
...
e.default=void 0
var r=(0,t.default)((function(){if("newsletter-analytics"===this.parent){this.route("newsletter",{path:"/"})
this.route("newsletter",{path:"/:newsletterUrn"},(function(){this.route("subscribers")}))}else{this.route("index",{path:"/"},(function(){this.route("content")
this.route("audience")}))
...
e.default=void 0
var r=(0,t.default)((function(){this.route("apply")
this.route("claim")
this.mount("jobs-post-apply",{as:"job-details-post-apply",path:"/post-apply",resetNamespace:!0})
this.mount("profile-opportunities",{as:"job-details-opportunities",path:"/opportunities",resetNamespace:!0})
this.mount("profile-edit",{as:"job-details-skill-edit",path:"/edit",resetNamespace:!0})}))
e.default=r}))
...
e.default=void 0
var r=(0,t.default)((function(){this.route("profile-views",(function(){this.route("index",{path:"/"})}))
this.route("search-appearances",(function(){this.route("index",{path:"/"})}))
...
e.default=void 0
var r=(0,t.default)((function(){this.route("start",(function(){this.route("add-email",{path:"add-email/:lifecycle"})
...
this.route("newsletters",{path:"/newsletters/:contentSeriesUrn"})
this.route("newsletters")}))
...
this.route("featured-content",(function(){this.route("index",{path:"/:topicName"})}))
...
e.default=void 0
var r=(0,t.default)((function(){this.route("index",{path:"/"},(function(){this.route("helpful-people",{path:"/helpfulPeople"})}))
...
e.default=void 0
var r=(0,t.default)((function(){this.route("redirect",{path:"/"})
...
e.default=void 0
var r=(0,t.default)((function(){this.route("index",{path:"/:universalName"},(function(){this.route("helpful-people",{path:"/helpfulPeople"})
this.mount("organization-featured-content",{path:"/featured-content"})}))
this.route("redirect",{path:"/"})}))
e.default=r}))
...
e.default=void 0
var r=(0,t.default)((function(){this.route("services-page",{path:"/services"},(function(){this.route("media")
this.route("edit")
...
e.default=void 0
var r=(0,t.default)((function(){this.route("index",{path:"/flow"},(function(){this.mount("profile-edit",{as:"resume-profile-edit",path:"/edit",resetNamespace:!0})}))
this.route("loading")
this.route("onboarding")}))
e.default=r}))
...
e.default=void 0
var r=(0,t.default)((function(){if("trust-verification-desktop"===this.parent){this.route("trust-verification-desktop",{path:"/"})
...
for(let a=0;a<t.length;++a){const n=t[a],s=V(e,n)
let l
if(r)if(s&&s in r){const e=0===n.indexOf(s)?n.substr(s.length+1):n
l=(0,o.get)(r[s],e)}else l=(0,o.get)(r,n)
i+=`::${n}:${l}`}return e+i.replace(G,"-")}
e.default=void 0
var j,P,O,k,x,M,E,N,T,A,z,R,U,S,I,C,D,L,q,K,F,H
const B=["authentication"]
let $=(j=(0,s.inject)("router"),P=(0,s.inject)("authentication@authenticated-user"),O=(0,s.inject)("client-sensor-web@client-sensor"),k=(0,s.inject)("global-nav-shared@badge"),x=(0,s.inject)("global-nav-shared@nav-interaction"),M=(0,s.inject)("html-document-title@document-title-poller"),E=(0,s.inject)("tracking"),N=(0,s.inject)("global-services@page-key-history"),T=(0,s.inject)("msg-overlay-manager@msg-overlay-manager"),A=(0,s.inject)("lix"),(0,_.default)(z=(R=class extends u.default{get isEmailDeeplinkRedirectEnabled(){return this.lix.getTreatmentIsEnabled("voyager.web.messaging-email-deeplink-redirect")}constructor(){super(...arguments);(0,r.default)(this,"location",p.default.locationType);(0,r.default)(this,"rootURL",p.default.routerRootURL);(0,r.default)(this,"didRunBigPipeDegradationSensor",!1);(0,t.default)(this,"router",U,this);(0,t.default)(this,"authenticatedUser",S,this);(0,t.default)(this,"clientSensor",I,this);(0,t.default)(this,"badgeService",C,this);(0,t.default)(this,"navInteraction",D,this);(0,t.default)(this,"documentService",L,this);(0,t.default)(this,"tracking",q,this);(0,t.default)(this,"pageKeyHistory",K,this);(0,t.default)(this,"msgOverlayService",F,this);(0,t.default)(this,"lix",H,this)
p.default.APP.inferHueIconForArtDecoButtons=this.lix.getTreatmentIsEnabled("voyager.web.infraux-hue-icons-in-ad-buttons");(0,w.setupRouteTracking)(this);(0,l.setupRouter)(this.router)
...
if(r.isGuestUser&&!r.shouldBypassAuth(e)&&(0,n.includesAnyTargetRoute)(B,e.to))return r.redirectToLogin(e)
const{trk:a}=e.to?e.to.queryParams:{}
if(a&&(this.isEmailDeeplinkRedirectEnabled&&a.includes("eml-email")||a.match(/(^ext-company_culture|^eml-(msg_digest|email_member_message_v2|email_messages_you_may_have_missed|email_inmail_initial_single|inmail_reply|inmail_accepted|email_premium_inmail_initial_single|email_jobs_open_candidates_inmails_ignored_single_01|premium_inmail_weekly_digest-body-view_all_messages|msg_digest-body-reply_to_sender|wym)).*/gi))){const t=(0,b.default)(e,this.isEmailDeeplinkRedirectEnabled)
...
this.pageKeyHistory.clear()}},U=(0,i.default)(R.prototype,"router",[j],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),S=(0,i.default)(R.prototype,"authenticatedUser",[P],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),I=(0,i.default)(R.prototype,"clientSensor",[O],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),C=(0,i.default)(R.prototype,"badgeService",[k],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),D=(0,i.default)(R.prototype,"navInteraction",[x],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),L=(0,i.default)(R.prototype,"documentService",[M],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),q=(0,i.default)(R.prototype,"tracking",[E],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),K=(0,i.default)(R.prototype,"pageKeyHistory",[N],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),F=(0,i.default)(R.prototype,"msgOverlayService",[T],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),H=(0,i.default)(R.prototype,"lix",[A],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),R))||z)
e.default=$
const G=/\./g
function V(e,t){const r=e.split(".")
let i=""
for(let e=0;e<r.length;e++){const a=r.slice(0,e+1).join(".")
if(0!==t.indexOf(a))break
i=a}return i}$.map((function(){this.route("authentication",{path:"/",resetNamespace:!0},(function(){(0,v.isIsolatedBuild)()&&this.route("aide",{resetNamespace:!0})
...
return!0}loading(){return!this.fastbootBpr.isSSRPath}},S=(0,i.default)(U.prototype,"storeShim",[j],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),I=(0,i.default)(U.prototype,"authenticatedUser",[P],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),C=(0,i.default)(U.prototype,"forceLogout",[O],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),D=(0,i.default)(U.prototype,"badgeService",[k],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),L=(0,i.default)(U.prototype,"tracking",[x],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),q=(0,i.default)(U.prototype,"lix",[M],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),K=(0,i.default)(U.prototype,"fastbootBpr",[E],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),F=(0,i.default)(U.prototype,"router",[N],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),H=(0,i.default)(U.prototype,"pemTracking",[T],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),B=(0,i.default)(U.prototype,"persistentToastManager",[A],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),$=(0,i.default)(U.prototype,"tagManager",[z],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),G=(0,i.default)(U.prototype,"registerTagManager",[R],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),(0,i.default)(U.prototype,"didTransition",[c.action],Object.getOwnPropertyDescriptor(U.prototype,"didTransition"),U.prototype),(0,i.default)(U.prototype,"error",[c.action],Object.getOwnPropertyDescriptor(U.prototype,"error"),U.prototype),(0,i.default)(U.prototype,"loading",[c.action],Object.getOwnPropertyDescriptor(U.prototype,"loading"),U.prototype),U)
e.default=X}))
define("voyager-web/routes/authentication",["exports","@babel/runtime/helpers/esm/initializerDefineProperty","@babel/runtime/helpers/esm/defineProperty","@babel/runtime/helpers/esm/applyDecoratedDescriptor","@babel/runtime/helpers/esm/initializerWarningHelper","@ember/destroyable","@ember/service","@ember/object","@ember/routing/route","nt-requests/requests/cards","global-utils/utils/is-browser","voyager-web/config/environment","global-utils/utils/get-ie-version","rsvp","global-utils/utils/url","takeover/utils/constants","@linkedin/ember-pem/utils/degradation-tracking-metadata","ember-lifeline","restli-utils","ember-app-scheduler","graphql-queries/queries/onboarding/member-email-address-by-find-email-for-verification.graphql","@ember/string","@linkedin/abuse-features-lib"],(function(e,t,r,i,a,o,n,s,l,u,d,c,p,f,m,h,b,g,y,v,_,w,j){Object.defineProperty(e,"__esModule",{value:!0})
e.default=void 0
var P,O,k,x,M,E,N,T,A,z,R,U,S,I,C,D,L,q,K,F,H,B,$,G,V,W,Q,Z,Y,J,X,ee,te,re,ie,ae,oe,ne,se
const le=["accelerometer","accessibility-events","ambient-light-sensor","background-sync","camera","clipboard-read","clipboard-write","geolocation","gyroscope","local-fonts","magnetometer","microphone","midi","notifications","payment-handler","persistent-storage","push","speaker-selection","storage-access"],ue=["architecture","bitness","fullVersionList","model","platformVersion","uaFullVersion"]
let de=(P=(0,n.inject)("authentication@authenticated-user"),O=(0,n.inject)("global-nav@nav"),k=(0,n.inject)("global-nav-shared@badge"),x=(0,n.inject)("date"),M=(0,n.inject)("gdpr-notice@gdpr-notice"),E=(0,n.inject)("profile-services@identity-store"),N=(0,n.inject)("global-services@store-shim"),T=(0,n.inject)("global-services@internal-logger"),A=(0,n.inject)("i18n"),z=(0,n.inject)("jet"),R=(0,n.inject)("lix"),U=(0,n.inject)("prefetch"),S=(0,n.inject)("router"),I=(0,n.inject)("global-services@router-scroll"),C=(0,n.inject)("global-services@session"),D=(0,n.inject)("coach-shared@onboarding"),L=(0,n.inject)("tracking"),q=(0,n.inject)("global-services@window"),K=(0,n.inject)("@linkedin/ember-restli-graphql@graphql"),F=class extends l.default{constructor(){super(...arguments);(0,t.default)(this,"authenticatedUser",H,this);(0,t.default)(this,"nav",B,this);(0,t.default)(this,"badge",$,this);(0,t.default)(this,"date",G,this);(0,t.default)(this,"gdprNotice",V,this);(0,t.default)(this,"identityStore",W,this);(0,t.default)(this,"storeShim",Q,this);(0,t.default)(this,"internalLogger",Z,this);(0,t.default)(this,"i18n",Y,this);(0,t.default)(this,"jet",J,this);(0,t.default)(this,"lix",X,this);(0,t.default)(this,"prefetch",ee,this);(0,t.default)(this,"router",te,this);(0,t.default)(this,"routerScroll",re,this);(0,t.default)(this,"session",ie,this);(0,t.default)(this,"coachOnboardingService",ae,this);(0,t.default)(this,"tracking",oe,this);(0,t.default)(this,"windowService",ne,this);(0,t.default)(this,"graphql",se,this);(0,r.default)(this,"feedModuleKey","home-feed:desktop");(0,r.default)(this,"targetName",void 0);(0,r.default)(this,"shouldTransitionToOnboarding",void 0);(0,r.default)(this,"shouldTransitionToHandleConfirmation",void 0)
this.session.validate()
this.routerScroll.setup()
this.router.on("routeWillChange",(e=>{var t
this.targetName=(null===(t=e.to)||void 0===t?void 0:t.name)??null}))
this.router.on("routeDidChange",(e=>{var t,r,i
this.targetName=(null===(t=e.to)||void 0===t?void 0:t.name)??null
if(this.shouldTransitionToOnboarding&&(null===(r=e.to)||void 0===r?void 0:r.name)===h.TAKEOVER_ROUTE_NAME_FEED){this.shouldTransitionToOnboarding=!1;(0,g.runTask)(this,(()=>{this.router.transitionTo("onboarding.start")}),2e3)}else if(this.shouldTransitionToHandleConfirmation&&(null===(i=e.to)||void 0===i||!i.name.startsWith("onboarding"))){var a
this.shouldTransitionToHandleConfirmation=!1
this.router.transitionTo("onboarding.start",{queryParams:{...(null===(a=this.router.currentRoute)||void 0===a?void 0:a.queryParams)||{},stepOverrides:"HANDLE_CONFIRMATION",session_redirect:`${(0,m.getDomainUrl)()}${this.router.currentURL}`}})}}))
...
this.tracking.fireTrackingPayload("ChameleonConfigLoadEvent",{configCount:e.data.elements.length,failedConfigs:r.map((e=>e.lix.trackingInfo.experimentId)),processingDuration:this.date.now()-t})}))}}return this.fetchMemberData()}}afterModel(){(0,o.isDestroying)(this)||(0,v.whenRouteIdle)().then((()=>{if(!(0,o.isDestroying)(this)){this.lix.getTreatmentIsEnabled("mid_ecosystem.lan_sdk_odp.signal_collection_experiment.web")&&this._trackBrowserAttributes()
this.lix.getTreatmentIsEnabled("voyager.web.abuse-features-lib.extension.detection")&&(0,j.fireExtensionDetectedEvents)(this.tracking,{accountType:"FLAGSHIP"})}}))}setReactivationFeatures(){const e=(0,m.addQueryParam)(`/${c.default.namespace}/premium/featureAccess`,"name","reactivationFeaturesEligible")
...
return(0,f.hashSettled)(e).then((e=>{var t,r,i,a,n
if((0,o.isDestroying)(this))return
const{me:s,takeovers:l,unconfirmedHandles:u}=e
if("rejected"===s.state){const e=parseInt(s.reason.errors[0].status,10)
if(e!==y.httpStatus.S_403_FORBIDDEN&&e!==y.httpStatus.S_404_NOT_FOUND)throw s.reason
this.authenticatedUser.redirectToLogin()}"rejected"===l.state&&this.jet.logError(l.reason,["takeover-error"],!1)
const c=this.authenticatedUser.setAuthenticatedUser("fulfilled"===s.state?s.value:void 0)
d.default&&this.identityStore.reloadVersionTag()
const p="fulfilled"===l.state?l.value??{}:{}
this.shouldTransitionToOnboarding=(null===(t=p.elements)||void 0===t||null===(r=t[0])||void 0===r||null===(i=r.launchpadCards)||void 0===i||null===(a=i[0])||void 0===a?void 0:a.cardType)===h.TAKEOVER_TYPE.ONBOARDING
const f="fulfilled"===(null==u?void 0:u.state)?u.value??{}:{}
this.shouldTransitionToHandleConfirmation=(null===(n=f.elements)||void 0===n?void 0:n.length)>0&&this.lix.getTreatmentIsEnabled("voyager.web.onboarding-handle-confirmation-force-takeover")
return{user:c,takeovers:p.elements}}))}prepareMemberData(){const{storeShim:e}=this,t=e.findRecord("com.linkedin.voyager.common.Me",0,{adapterOptions:{url:`/${c.default.namespace}/me`}}),r=e.queryURL("voyagerLaunchpadDashLaunchpadViews",{adapterOptions:{degradations:[new b.default("voyager-launchpad-views","failed-fetching-launchpad-views",{productName:h.TAKEOVER_PEM_PRODUCT_NAME})],degradedEntityIDsToRemove:[]},reload:!0,params:{q:"context",launchpadContext:"TAKEOVER",recipe:"com.linkedin.voyager.dash.deco.launchpad.LaunchpadView"}})
this.gdprNotice.loadPsettings()
return{me:t,takeovers:r,unconfirmedHandles:this.graphql.executeQuery(_.default).then((e=>{if(!(0,o.isDestroying)(this))return e.data.contactsDashMemberEmailAddressByFindEmailForVerification}))}}setupController(e){if(!(0,o.isDestroying)(this)){super.setupController(...arguments)
...
this.internalLogger.log({reason:t},["error-js"])}async _trackBrowserAttributes(){if(!d.default)return
const{appVersion:e,buildID:t,connection:{downlink:r,downlinkMax:i,effectiveType:a,rtt:n,saveData:s,type:l}={},deviceMemory:u,doNotTrack:c,hardwareConcurrency:p,language:f,languages:m,maxTouchPoints:h,platform:b,storage:g,vendor:y}=this.windowService.navigator,{width:v,height:_,scale:w}=this.windowService.getVisualViewport()??{},{availTop:j,availLeft:P,availHeight:O,availWidth:k,top:x,left:M,height:E,width:N,pixelDepth:T,colorDepth:A,orientation:{type:z,angle:R}={}}=this.windowService.getScreen()??{},U=await this._getKeyboardLayout()
if((0,o.isDestroying)(this))return
const S=await this._getPermissionsStatuses()
if((0,o.isDestroying)(this))return
const I=await this._getUserAgentData()
if((0,o.isDestroying)(this))return
let C,D
try{({quota:C,usage:D}=await(null==g?void 0:g.estimate())??{})
if((0,o.isDestroying)(this))return}catch(e){}this.tracking.fireTrackingPayload("WebSessionCreatedEvent",{appVersion:e,buildId:t,connection:{downlink:r,downlinkMax:i,effectiveType:a,rtt:n,saveData:s,type_AvroSanitized_:l},deviceMemory:u,doNotTrack:c,hardwareConcurrency:p,keyboardLayout:U,language:f,languages:null==m?void 0:m.join(" "),maxTouchPoints:h,permissions:S,platform:b,userAgentData:I,screen:{availTop:j,availLeft:P,availHeight:O,availWidth:k,top:x,left:M,height:E,width:N,pixelDepth:T,colorDepth:A,orientation:{type_AvroSanitized_:z,angle:R}},storageEstimate:{quota:C,usage:D},timeZone:this.windowService.getTimezone(),timeZoneOffset:new Date(this.date.now()).getTimezoneOffset(),vendor:y,visualViewport:{width:v,height:_,scale:w}},{header:{memberId:this.authenticatedUser.memberId}})}async _getKeyboardLayout(){const{keyboard:e}=this.windowService.navigator
if(!e)return
let t=null
try{var r
t=await(null===(r=e.getLayoutMap)||void 0===r?void 0:r.call(e))
if((0,o.isDestroying)(this))return}catch(e){}return t?"qwertyuiopasdfghjklzxcvbnm".split("").reduce(((e,r)=>{const i=t.get(`Key${r.toUpperCase()}`)
return i?e+i:e}),""):void 0}async _getPermissionsStatuses(){const{permissions:e}=this.windowService.navigator
if(!e)return
const t=await Promise.allSettled(le.map((t=>e.query({name:t}))))
if((0,o.isDestroying)(this))return
const r={}
t.forEach(((e,t)=>{var i
if(!e.value)return
const a=(0,w.camelize)(le[t])
r[a]=null===(i=e.value.state)||void 0===i?void 0:i.toUpperCase()}))
return r}async _getUserAgentData(){const{userAgentData:e}=this.windowService.navigator
if(!e)return
const t=await Promise.allSettled(ue.map((t=>e.getHighEntropyValues([t]))))
if((0,o.isDestroying)(this))return
const r={}
t.forEach(((e,t)=>{if(!e.value)return
const i=ue[t],a=e.value[i]
r[i]="fullVersionList"===i?{items_AvroSanitized_:a||[]}:a}))
const{brands:i=[],mobile:a,platform:n}=e
return{brands:{items_AvroSanitized_:i},mobile:a,platform:n,...r}}},H=(0,i.default)(F.prototype,"authenticatedUser",[P],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),B=(0,i.default)(F.prototype,"nav",[O],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),$=(0,i.default)(F.prototype,"badge",[k],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),G=(0,i.default)(F.prototype,"date",[x],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),V=(0,i.default)(F.prototype,"gdprNotice",[M],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),W=(0,i.default)(F.prototype,"identityStore",[E],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),Q=(0,i.default)(F.prototype,"storeShim",[N],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),Z=(0,i.default)(F.prototype,"internalLogger",[T],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),Y=(0,i.default)(F.prototype,"i18n",[A],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),J=(0,i.default)(F.prototype,"jet",[z],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),X=(0,i.default)(F.prototype,"lix",[R],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),ee=(0,i.default)(F.prototype,"prefetch",[U],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),te=(0,i.default)(F.prototype,"router",[S],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),re=(0,i.default)(F.prototype,"routerScroll",[I],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),ie=(0,i.default)(F.prototype,"session",[C],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),ae=(0,i.default)(F.prototype,"coachOnboardingService",[D],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),oe=(0,i.default)(F.prototype,"tracking",[L],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),ne=(0,i.default)(F.prototype,"windowService",[q],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),se=(0,i.default)(F.prototype,"graphql",[K],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),(0,i.default)(F.prototype,"fieldChanged",[s.action],Object.getOwnPropertyDescriptor(F.prototype,"fieldChanged"),F.prototype),F)
e.default=de}))
...
this.router.replaceWith("profile.common.recent-activity",e)}},u=(0,i.default)(l.prototype,"router",[s],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),l)
e.default=d}))
...
Object.defineProperty(e,"default",{enumerable:!0,get:function(){return t.default}})}))
define("voyager-web/services/prefetch",["exports","@babel/runtime/helpers/esm/initializerDefineProperty","@babel/runtime/helpers/esm/defineProperty","@babel/runtime/helpers/esm/applyDecoratedDescriptor","@babel/runtime/helpers/esm/initializerWarningHelper","@ember/destroyable","ember","@ember/object","@ember/service","ember-cli-pemberly-tracking/utils/user-timing","voyager-web/utils/prefetch-history","voyager-web/utils/prefetch-constants","ember-cli-pemberly-tracking/utils/uuid","jobs-and-jobs-search/utils/client-sensor-constants","ember-app-scheduler","rsvp","@ember/runloop","@ember/utils","module-boundary-utils","ember-lifeline","global-utils/utils/logger","search-utils/utils/constants"],(function(e,t,r,i,a,o,n,s,l,u,d,c,p,f,m,h,b,g,y,v,_,w){Object.defineProperty(e,"__esModule",{value:!0})
e.default=void 0
var j,P,O,k,x,M,E,N,T,A,z,R,U,S,I
function C(e,t,r){u.default.addMarker(`mark_ipf_${e}-${t}_${r}`)}const D=Symbol("Prefetch flag symbol"),L=["feed-jobs","jobs-jobs","msg-jobs","network-jobs","notifications-jobs","profile-jobs"]
let q=(j=(0,l.inject)("router"),P=(0,l.inject)("asset-loader"),O=(0,l.inject)("global-services@store-shim"),k=(0,l.inject)("tracking"),x=(0,l.inject)("@linkedin/ember-restli-graphql@graphql"),M=(0,l.inject)("client-sensor-web@client-sensor"),E=(0,l.inject)("jet"),N=class e extends l.default{constructor(){super(...arguments);(0,t.default)(this,"router",T,this);(0,t.default)(this,"assetLoader",A,this);(0,t.default)(this,"storeShim",z,this);(0,t.default)(this,"tracking",R,this);(0,t.default)(this,"graphql",U,this);(0,t.default)(this,"clientSensor",S,this);(0,t.default)(this,"jet",I,this);(0,r.default)(this,"prefetchedBundles",{});(0,r.default)(this,"historyLength",2);(0,r.default)(this,"currentPageId",(0,p.default)());(0,r.default)(this,"previousPageId",null);(0,r.default)(this,"isPrefetchingAssetsEnabled",!1);(0,r.default)(this,"isTransitioning",!1);(0,r.default)(this,"_loadBundleRunTaskTimer",[])
...
if("GraphQLQueryError"===(null==e?void 0:e.name)&&"search.results"===r){const t=[w.JET_TAGS.CLUSTER_PREFETCH_RESULTS,`query: ${i}`]
...
const t=[w.JET_TAGS.CLUSTER_PREFETCH_RESULTS,`query: ${i}`]
...
return l}))
r=r.filter((e=>null!==e))
return(0,h.all)(r)}))}prefetchAssets(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:"dummy_pageKey",r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:"unknown"
return(0,y.hasBundle)(e)&&!this.prefetchedBundles[e]?(0,m.whenRouteIdle)().then((()=>{if(!(0,o.isDestroying)(this))return this._loadBundleHelper(e,t,r)})):(0,h.resolve)()}prefetchAssetsWithRouteName(t){const r=e.getMappedParametersFromRouteName(t)
if((0,g.isPresent)(r)){const{bundleMetadata:e}=r,i=t.split(".index")[0]
...
const e=`INFRA-${i}-${t}`,a=(0,v.runTask)(this,(()=>{this._loadBundleHelper(t,r,e)}),2e3)
...
null!==i&&i.completed&&i.sourcePageId===a&&C("consume",c.PREFETCH_EVENT_TYPE.M3_REQUEST,i.scenario)}enablePrefetchingAssets(){this.isPrefetchingAssetsEnabled=!0}_loadBundleHelper(e,t,r){return this.assetLoader.loadBundle(e).then((()=>{if(!(0,o.isDestroying)(this)){this._onAssetsPrefetchStart(e,t,r)
...
C("start",c.PREFETCH_EVENT_TYPE.ASSETS,r)}_onM3RequestPrefetchStart(e,t){this.history.onM3RequestPrefetchStart(e,t)
C("start",c.PREFETCH_EVENT_TYPE.M3_REQUEST,t)}_onM3RequestPrefetchComplete(e){this.history.onM3RequestPrefetchComplete(e)}_handlePrefetchComplete(e,t,r){this._onM3RequestPrefetchComplete(t)
void 0===r||n.default.testing||(0,b.later)((()=>e.unloadRecord()),r)}_updatePageId(){this.previousPageId=this.currentPageId
this.currentPageId=(0,p.default)()}static getMappedParametersFromRouteName(e){return c.ROUTE_TO_ASSET_PARAM_MAP[e]}},T=(0,i.default)(N.prototype,"router",[j],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),A=(0,i.default)(N.prototype,"assetLoader",[P],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),z=(0,i.default)(N.prototype,"storeShim",[O],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),R=(0,i.default)(N.prototype,"tracking",[k],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),U=(0,i.default)(N.prototype,"graphql",[x],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),S=(0,i.default)(N.prototype,"clientSensor",[M],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),I=(0,i.default)(N.prototype,"jet",[E],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),N)
e.default=q}))
...
e.default=void 0
var r=(0,t.createTemplateFactory)({id:"TCmVA2dY",block:'[[[41,[30,0,["isBrowser"]],[[[41,[51,[30,0,["isGuest"]]],[[[41,[30,0,["showNav"]],[[[1,"      "],[8,[39,2],null,null,null],[1,"\\n      "],[8,[39,3],null,null,[["default"],[[[[1,"\\n"],[41,[51,[30,0,["isGlobalSearchBarHidden"]]],[[[1,"          "],[8,[39,4],[[24,0,"global-nav__search-typeahead"]],[["@isReflowedSearchBoxFocused","@toggleReflowedSearchBoxFocus","@searchKeywords","@setSearchKeywords","@typeaheadId","@transitionToRoute"],[[30,1,["isReflowedSearchBoxFocused"]],[30,1,["toggleReflowedSearchBoxFocus"]],[30,0,["searchKeywords"]],[30,0,["setSearchKeywords"]],"global-nav-typeahead",[30,0,["handleTransitionToRoute"]]]],null],[1,"\\n"]],[]],null],[1,"      "]],[1]]]]],[1,"\\n"]],[]],null],[1,"\\n    "],[8,[39,5],null,null,[["default"],[[[[1,"\\n"],[41,[30,2,["inappAlert"]],[[[1,"        "],[8,[39,6],null,[["@inappAlert","@removeAlert"],[[30,2,["inappAlert"]],[30,2,["removeAlert"]]]],null],[1,"\\n"]],[]],null],[1,"    "]],[2]]]]],[1,"\\n"]],[]],null]],[]],null],[1,"\\n"],[41,[30,0,["model","takeovers"]],[[[1,"  "],[8,[39,7],null,[["@targetName","@takeovers","@isSignInFlow"],[[30,0,["targetName"]],[30,0,["model","takeovers"]],true]],null],[1,"\\n"]],[]],null],[1,"\\n"],[10,0],[15,0,[30,0,["outletClass"]]],[12],[1,"\\n"],[41,[30,0,["isDevelopmentEnvironment"]],[[[1,"    "],[8,[39,8],null,null,null],[1,"\\n"]],[]],null],[1,"  "],[46,[28,[37,10],null,null],null,null,null],[1,"\\n"],[13],[1,"\\n\\n"],[10,0],[14,0,"application-outlet__overlay-container"],[12],[1,"\\n"],[41,[30,0,["isMessagingOverlayEnabled"]],[[[1,"    "],[46,[28,[37,11],["msg-overlay"],null],null,null,null],[1,"\\n"]],[]],null],[1,"\\n"],[41,[51,[30,0,["isGuest"]]],[[[41,[30,0,["isCoachEnabled"]],[[[1,"      "],[8,[39,12],null,[["@renderType"],["OVERLAY"]],null],[1,"\\n"],[41,[30,0,["withAIInsightsModal"]],[[[1,"        "],[8,[39,13],null,[["@onboardingFlowType"],[[30,0,["coachOnboardingService","premiumSplashType"]]]],null],[1,"\\n"]],[]],null]],[]],null]],[]],null],[13],[1,"\\n\\n"],[41,[30,0,["detachedUpsellModal","upsellModalIsOpen"]],[[[41,[30,0,["isUpsellTemplateComponentV2Enabled"]],[[[1,"    "],[8,[39,14],null,[["@upsellCard","@defaultConfig","@onDismissClick","@onUpsellClick"],[[30,0,["detachedUpsellModal","upsellCard"]],[30,0,["detachedUpsellModal","defaultConfig"]],[30,0,["detachedUpsellModal","closeAndDestroyModal"]],[30,0,["detachedUpsellModal","closeAndDestroyModal"]]]],null],[1,"\\n"]],[]],[[[1,"    "],[8,[39,15],null,[["@upsellCard","@defaultConfig","@onDismissClick","@onUpsellClick"],[[30,0,["detachedUpsellModal","upsellCard"]],[30,0,["detachedUpsellModal","defaultConfig"]],[30,0,["detachedUpsellModal","closeAndDestroyModal"]],[30,0,["detachedUpsellModal","closeAndDestroyModal"]]]],null],[1,"\\n"]],[]]]],[]],null],[1,"\\n"],[41,[51,[30,0,["isGuest"]]],[[[1,"  "],[8,[39,16],null,[["@bundle"],["msg-multisend"]],[["resolved"],[[[[1,"\\n"],[44,[[28,[30,3,["component"]],["multi-send"],null]],[[[1,"        "],[8,[30,4],null,null,null],[1,"\\n"]],[4]]],[1,"    "]],[3]]]]],[1,"\\n"]],[]],null],[1,"\\n"],[41,[51,[30,0,["isGuest"]]],[[[1,"  "],[8,[39,18],null,null,null],[1,"\\n"]],[]],null]],["nav","inappAlertManager","resolved","MultiSend"],false,["if","unless","global-nav@global-nav-a11y-menu","global-nav@global-nav","search-global-typeahead@search-global-typeahead","video-inapp-alert@inapp-alerts-manager","video-inapp-alert@inapp-alert","takeover@takeover-container","ember-cli-pemberly-node-console@node-console","component","-outlet","-mount","coach@container","coach-shared@ai-insights-modal","s-upsell@upsell-templates-v2/upsell-template-container-v2","s-upsell@upsell-templates/upsell-template-container","asset-loader@asset-loader","let","third-party-tracking@third-party-tracking"]]',moduleName:"voyager-web/templates/authentication.hbs",isStrictMode:!1})
e.default=r}))
...
"undefined"==typeof FastBoot&&(runningTests||require("voyager-web/app").default.create({inferHueIconForArtDecoButtons:!1,locale:"en_US",rumConfig:{pageKeyPrefix:"d_","beacon-service":"tracking","event-name":"RealUserMonitoringEvent","enable-cdn-tracking":!0,"enable-pop-tracking":!0,"user-timing-mark-enabled":!0,"web-vitals-enabled":!0,"enable-memory-measurement":!0},name:"voyager-web",version:"0.0.0-productspec+2d5b0a17"}))
